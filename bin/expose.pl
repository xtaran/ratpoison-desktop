#!/usr/bin/perl
# Maintainer: Trent Buck <address@hidden>
# License: Public Domain
# Wiki: http://ratpoison.antidesktop.net/wiki/expose.pl
# Download: http://lists.nongnu.org/archive/html/ratpoison-devel/2005-07/txtvG3sxhd6TB.txt
